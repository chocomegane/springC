...
<!-- 値段検索 -->
<form action="/searchCinemaPrice" name="searchCinemaPriceForm">
...
<!-- ジャンル検索 -->
<form action="/searchCinemaGenre" name="searchCinemaGenreForm">	
...
<!-- メディアタイプ検索 -->
<form action="/searchCinemaMediaType" name="searchCinemaMediaTypeForm">	
