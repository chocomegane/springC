...
<tr><td align="right">名前</td><td align="center"><form:input path="name" style="width:20em; height:2em" value="${user.name}"/><form:errors path="name" cssStyle="color:red" element="div"/></td></tr>
 ...
 <table class="table table-striped">
<tr><td align="center">名前:<form:input path="name" style="width:20em; height:2em" value="${user.name}"/><form:errors path="name" cssStyle="color:red" element="div"/></td></tr>
			<tr><td align="center">住所:<form:input path="address" style="width:20em; height:2em" value="${user.address}"/><form:errors path="address" cssStyle="color:red" element="div"/></td></tr>
			<tr><td align="center">メールアドレス:<form:input path="email" style="width:20em; height:2em" value="${user.email}"/><form:errors path="email" cssStyle="color:red" element="div"/></td></tr>
			<tr>
...
<input class="btn btn-default btn-lg" type="submit" value="更新">
<c:out value="${message}"/>
</form:form> 
</div>
