...
<h3>削除済み商品一覧</h3>
<!-- テキスト検索 -->
<form action="<%=request.getContextPath() %>/admin/serchCinema/deleteTitle">
...
<!-- 値段検索 -->
<form action="<%=request.getContextPath() %>/admin/serchCinema/deletePrice" name="searchDeleteCinemaPriceForm">
...
<!-- ジャンル検索 -->
<form action="<%=request.getContextPath() %>/admin/serchCinema/deleteGenre" name="searchDeleteCinemaGenreForm">	
...
<!-- メディアタイプ検索 -->
<form action="<%=request.getContextPath() %>/admin/serchCinema/deleteMediaType" name="searchDeleteCinemaMediaTypeForm">	
